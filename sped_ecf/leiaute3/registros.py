...
from sped_common.campos import *
...
class Registro0010(Registro):
    ...
    campos = [
        ...
        Campo(13, 'APUR_CSLL'),
        CampoNumerico(14, 'IND_REC_RECEITA'),
    ]
...
class Registro0020(Registro):
    ...
    campos = [
        ...
        Campo(32, 'IND_PAIS_A_PAIS'),
    ]


class Registro0021(Registro):
    """
    PARÂMETROS DE IDENTIFICAÇÃO DOS TIPOS DE PROGRAMA
    """
    campos = [
        CampoFixo(1, 'REG', '0021'),
        Campo(2, 'IND_REPES'),
        Campo(3, 'IND_RECAP'),
        Campo(4, 'IND_PADIS'),
        Campo(5, 'IND_PATVD'),
        ...
        Campo(9, 'IND_RETAERO'),
        Campo(10, 'IND_RECINE'),
        Campo(11, 'IND_RESIDUOS_SOLIDOS'),
        Campo(12, 'IND_RECOPA'),
        Campo(13, 'IND_COPA_DO_MUNDO'),
        Campo(14, 'IND_RETID'),
        Campo(15, 'IND_REPNBL_REDES'),
        Campo(16, 'IND_REIF'),
        Campo(17, 'IND_OLIMPIADAS'),
    ]
...
class RegistroW001(Registro):
    """
    ABERTURA DO BLOCO W:  Declaração País-a-País (Country-by-Country Report)
    """
    campos = [
        CampoFixo(1, 'REG', 'W001'),
        Campo(2, 'IND_DAD'),
    ]


class RegistroW100(Registro):
    """
    INFORMAÇÕES SOBRE O GRUPO MULTINACIONAL E A ENTIDADE DECLARANTE - DECLARAÇÃO PAÍS-A-PAÍS
    """
    campos = [
        CampoFixo(1, 'REG', 'W100'),
        Campo(2, 'NOME_MULTINACIONAL'),
        Campo(3, 'IND_CONTROLADORA'),
        Campo(4, 'NOME_CONTROLADORA'),
        Campo(5, 'JURISDICAO_CONTROLADORA'),
        Campo(6, 'TIN_CONTROLADORA'),
        Campo(7, 'IND_ENTREGA'),
        Campo(8, 'IND_MODALIDADE'),
        Campo(9, 'NOME_SUBSTITUTA'),
        Campo(10, 'JURISDICAO_SUBSTITUTA'),
        Campo(11, 'TIN_SUBSTITUTA'),
        CampoData(12, 'DT_INI'),
        CampoData(13, 'DT_FIN'),
        Campo(14, 'TIP_MOEDA'),
        Campo(15, 'IND_IDIOMA'),
...
class RegistroW200(Registro):
    """
    DECLARAÇÃO PAÍS-A-PAÍS
    """
    campos = [
        CampoFixo(1, 'REG', 'W200'),
        CampoNumerico(2, 'JURISDICAO', precisao=2),
        CampoNumerico(3, 'VL_REC_NAO_REL_EST', precisao=2),
        CampoNumerico(4, 'VL_REC_NAO_REL', precisao=2),
        CampoNumerico(5, 'VL_REC_REL_EST', precisao=2),
        CampoNumerico(6, 'VL_REC_REL', precisao=2),
        CampoNumerico(7, 'VL_REC_TOTAL_EST', precisao=2),
        CampoNumerico(8, 'VL_REC_TOTAL', precisao=2),
        CampoNumerico(9, 'VL_LUC_PREJ_ANTES_IR_EST', precisao=2),
        CampoNumerico(10, 'VL_LUC_PREJ_ANTES_IR', precisao=2),
        CampoNumerico(11, 'VL_IR_PAGO_EST', precisao=2),
        CampoNumerico(12, 'VL_IR_PAGO', precisao=2),
        CampoNumerico(13, 'VL_IR_DEVIDO_EST', precisao=2),
        CampoNumerico(14, 'VL_IR_DEVIDO', precisao=2),
        CampoNumerico(15, 'VL_CAP_SOC_EST', precisao=2),
        CampoNumerico(16, 'VL_CAP_SOC', precisao=2),
        CampoNumerico(17, 'VL_LUC_ACUM_EST', precisao=2),
        CampoNumerico(18, 'VL_LUC_ACUM', precisao=2),
        CampoNumerico(19, 'VL_ATIV_TANG_EST', precisao=2),
        CampoNumerico(20, 'VL_ATIV_TANG', precisao=2),
        CampoNumerico(21, 'NUM_EMP', precisao=2),
    ]


class RegistroW250(Registro):
    """
    DECLARAÇÃO PAÍS-A-PAÍS - ENTIDADES INTEGRANTES
    """
    campos = [
        CampoFixo(1, 'REG', 'W250'),
        Campo(2, 'JUR_DIFERENTE'),
        Campo(3, 'NOME'),
        Campo(4, 'TIN'),
        Campo(5, 'JURISDICAO_TIN'),
        Campo(6, 'NI'),
        Campo(7, 'JURISDICAO_NI'),
        Campo(8, 'TIPO_NI'),
        Campo(9, 'TIP_END'),
        Campo(10, 'ENDEREÇO'),
        Campo(11, 'NUM_TEL'),
        ...
        Campo(24, 'ATIV_12'),
        Campo(25, 'ATIV_13'),
        Campo(26, 'DESC_OUTROS'),
        Campo(27, 'OBSERVAÇÃO'),
    ]


class RegistroW300(Registro):
    """
    OBSERVAÇÕES ADICIONAIS - DECLARAÇÃO PAÍS-A-PAÍS
    """
    campos = [
        CampoFixo(1, 'REG', 'W300'),
        Campo(2, 'JURISDICAO'),
        Campo(3, 'IND_REC_NAO_REL'),
        Campo(4, 'IND_REC_REL'),
        Campo(5, 'IND_REC_TOTAL'),
        Campo(6, 'IND_LUC_PREJ_ANTES_IR'),
        Campo(7, 'IND_IR_PAGO'),
        Campo(8, 'IND_IR_DEVIDO'),
        Campo(9, 'IND_CAP_SOC'),
        Campo(10, 'IND_LUC_ACUM'),
        Campo(11, 'IND_ATIV_TANG'),
        Campo(12, 'IND_NUM_EMP'),
        Campo(13, 'OBSERVAÇÃO'),
        Campo(14, 'FIM_OBSERVACAO'),
    ]


class RegistroW990(Registro):
    """
    ENCERRAMENTO DO BLOCO W
    """
    campos = [
        CampoFixo(1, 'REG', 'W990'),
        CampoNumerico(2, 'QTD_LIN'),
    ]
...
class RegistroX351(Registro):
    ...
    campos = [
        ...
        CampoNumerico(4, 'RES_ISEN_PETR_PER'),
        CampoNumerico(5, 'RES_ISEN_PETR_PER_REAL'),
        CampoNumerico(6, 'RES_NEG_ACUM'),
        CampoNumerico(7, 'RES_POS_TRIB'),
        CampoNumerico(8, 'RES_POS_TRIB_REAL'),
        CampoNumerico(9, 'IMP_LUCR'),
        CampoNumerico(10, 'IMP_LUCR_REAL'),
        CampoNumerico(11, 'IMP_PAG_REND'),
        CampoNumerico(12, 'IMP_PAG_REND_REAL'),
        CampoNumerico(13, 'IMP_RET_EXT'),
        CampoNumerico(14, 'IMP_RET_EXT_REAL'),
        CampoNumerico(15, 'IMP_RET_BR'),
    ]
...
class RegistroY620(Registro):
    ...
    campos = [
        ...
        CampoData(2, 'DT_EVENTO'),
        Campo(3, 'IND_RELAC'),
        CampoNumerico(4, 'PAIS'),
        CampoCNPJ(5, 'CNPJ'),
        Campo(6, 'NOM_EMP'),
        CampoNumerico(7, 'VALOR_REAIS'),
        CampoNumerico(8, 'VALOR_ESTR'),
        CampoNumerico(9, 'PERC_CAP_TOT'),
        CampoNumerico(10, 'PERC_CAP_VOT'),
        CampoNumerico(11, 'RES_EQ_PAT'),
        Campo(12, 'DATA_AQUIS'),
        Campo(13, 'IND_PROC_CART'),
        Campo(14, 'NUM_PROC_CART'),
        Campo(15, 'NOME_CART'),
        Campo(16, 'IND_PROC_RFB'),
        Campo(17, 'NUM_PROC_RFB'),
    ]
...
class RegistroY671(Registro):
    ...
    campos = [
        ...
        CampoNumerico(10, 'VL_OC_SEM_IOF', precisao=2),
        CampoNumerico(11, 'VL_FOLHA_ALIQ_RED', precisao=2),
        CampoNumerico(12, 'VL_ALIQ_RED', precisao=2),
        Campo(13, 'IND_ALTER_CAPITAL'),
        Campo(14, 'IND_BCN_CSLL'),
    ]
...
class RegistroY720(Registro):
    """
    INFORMAÇÕES DE PERÍODOS ANTERIORES
    """
    campos = [
        CampoFixo(1, 'REG', 'Y720'),
        CampoNumerico(2, 'LUC_LIQ', precisao=2),
        CampoData(3, 'DT_LUC_LIQ'),
        CampoNumerico(4, 'REC_BRUT_ANT', precisao=2),
    ]
